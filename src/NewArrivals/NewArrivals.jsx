    ...
    <div className="fadeanimation">
      ...
      <div className="w-[96%] m-auto mb-10 shadow-fuchsia-800 shadow-md flex flex-col my-6 bg-gradient-to-r from-black to-[#8F0060]">
        ...
        <div className="my-8 grid justify-items-center min-[1020px]:grid-cols-3 min-[680px]:grid-cols-2 grid-cols-1 min-[1180px]:w-full min-[1180px]:justify-evenly mx-auto">
          <div
            className="border-4 bg-white border-bg-pink rounded-t-full min-[1180px]:w-[320px] w-[240px] mx-8 mt-4 hover:scale-105"
          ...
          >
            <div className="p-5 min-[1180px]:pt-20 pt-10 flex justify-center">
              <img
                src={Product4}
                alt="Product3"
                className="min-[1180px]:h-[240px] h-[180px] min-[1180px]:mt-[40px] mt-[24px] min-[1180px]:mb-[20px] mb-[2px]"
              />
            </div>
            <div className="font-lexend min-[1180px]:text-xl text-base pt-2 border-t-4 border-bg-pink">
              ...
              <div className="flex justify-between min-[1180px]:text-base text-sm mt-1">
          ...
          <div
            className="border-4 bg-white max-[1020px]:min-[680px]:col-span-2 col-span-1 border-bg-pink rounded-t-full min-[1180px]:w-[320px] w-[240px] mx-8 mt-4 hover:scale-105"
            style={{ transition: "all 0.4s ease-in-out" }}
          >
            <div className="p-5 min-[1180px]:pt-20 pt-10 flex justify-center">
              <img
